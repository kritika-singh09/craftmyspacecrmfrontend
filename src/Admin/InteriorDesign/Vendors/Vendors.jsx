        ...
        <div className="space-y-10 pb-12 animate-in fade-in duration-700">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-orange-300 mt-2 font-medium tracking-wide">Manage suppliers, manufacturing units, and installation contractors.</p>
                </div>
                ...
                {vendors.map((v, i) => (
                    <div key={i} className="group bg-white dark:bg-brand-900/30 p-10 rounded-[3.5rem] shadow-premium border border-orange-50/50 dark:border-brand-800/50 hover:border-orange-500 transition-all duration-500">
                        <div className="flex justify-between items-start mb-8">
                            <div className="w-16 h-16 rounded-2xl bg-orange-50 dark:bg-brand-800 flex items-center justify-center text-3xl shadow-inner group-hover:bg-orange-600 group-hover:text-white transition-all duration-500">🏭</div>
                        ...
                        <div className="mt-8 pt-6 border-t border-orange-50 dark:border-brand-800 space-y-4 text-indigo-900 dark:text-white">
                            ...
                            <div className="flex justify-between items-center bg-orange-50/30 dark:bg-brand-800/40 p-4 rounded-2xl mt-4">
                                <div>
                                    <p className="text-[9px] font-black text-gray-700 uppercase tracking-widest">Active Orders</p>
