    ...
    <div className="space-y-8 pb-8">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm font-medium text-gray-500 mt-1">Deep Analytics and Performance Metrics</p>
        </div>
        <button className="group flex items-center gap-2 bg-brand-600 text-white px-6 py-3 rounded-2xl font-bold text-sm shadow-premium hover:bg-brand-700 transition-all hover:-translate-y-0.5">
          <span className="text-xl leading-none group-hover:rotate-90 transition-transform">⚙️</span>
          Configure Reports
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { icon: '📊', title: 'Projects', desc: 'Progress & Performance' },
          { icon: '💰', title: 'Financials', desc: 'Budget & Yield' },
          { icon: '👷', title: 'Workforce', desc: 'Efficiency & Payroll' },
          { icon: '📦', title: 'Inventory', desc: 'Stock & Logistics' }
        ].map((cat, idx) => (
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tight">Generated • {report.date}</p>
