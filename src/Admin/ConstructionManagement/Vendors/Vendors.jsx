    ...
    <div className="space-y-8 pb-8">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm font-medium text-gray-400 dark:text-brand-300 mt-1">Sourcing and Procurement Hub</p>
        </div>
          ...
          <div key={vendor.id} className="card-premium p-8 group">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-[10px] font-semibold text-gray-400 dark:text-brand-400 uppercase tracking-widest">Certified Supplier</p>
              </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex justify-between items-center py-2 border-b border-brand-50/50 dark:border-brand-800/50">
                <span className="text-[11px] font-bold text-gray-400 dark:text-brand-400 uppercase tracking-tight">Primary Material</span>
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-50 dark:border-brand-800/50">
                <span className="text-[11px] font-semibold text-gray-400 dark:text-brand-400 uppercase tracking-tight">Current Rate</span>
          ...
          <div className="group flex justify-between items-center p-4 bg-blue-50/30 dark:bg-blue-900/40 rounded-2xl border border-blue-100/50 dark:border-blue-800/50 hover:bg-blue-50 dark:hover:bg-blue-900/60 transition-all cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] font-bold text-gray-400 dark:text-brand-400 uppercase tracking-widest">200 Bags Cement • ₹76,000</p>
              </div>
            </div>
          ...
          <div className="group flex justify-between items-center p-4 bg-blue-50/30 dark:bg-blue-900/40 rounded-2xl border border-blue-100/50 dark:border-blue-800/50 hover:bg-blue-50 dark:hover:bg-blue-900/60 transition-all cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] font-bold text-gray-400 dark:text-brand-400 uppercase tracking-widest">5 Tons Steel • ₹2,25,000</p>
              </div>
            </div>
