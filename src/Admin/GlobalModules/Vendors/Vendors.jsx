    ...
    <div className="space-y-8 pb-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
          <div>
            <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-tight" style={{ color: theme.textPrimary }}>Vendor Master</h2>
          ...
          <button
            ...
            className="group flex items-center gap-2 text-white px-6 py-3 rounded-xl font-black uppercase tracking-[0.15em] text-[10px] shadow-premium transition-all hover:-translate-y-1 w-full sm:w-auto justify-center"
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative group flex-1">
            ...
            <input
              ...
              className="pl-10 pr-4 py-3 rounded-xl border bg-transparent outline-none focus:ring-2 focus:ring-blue-500/20 transition-all font-bold text-xs w-full"
          ...
          <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl overflow-x-auto">
            {['ALL', 'CONSTRUCTION', 'ARCHITECTURE', 'INTERIOR'].map(domain => (
              <button
                ...
                className={`px-3 sm:px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${filterDomain === domain ? 'bg-white dark:bg-slate-700 shadow-sm text-blue-600' : 'text-slate-400 hover:text-slate-600'}`}
              >
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-sm truncate" style={{ color: theme.textPrimary }}>{vendor.name}</h3>
      ...
      {selectedVendor && (
        <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-[100] p-2 sm:p-4 bg-slate-900/40">
          <div className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl relative w-full max-w-6xl max-h-[95vh] overflow-y-auto" style={{ backgroundColor: theme.cardBg }}>
